...
app.post('/commercial_invoices_vehicles', async (req, res) => {
    try {
...
app.get('/blank-valuation-form-trinidad', (req, res) => {
...
app.post('/generate-pre-signed-valuation-form-v2', async (req, res) => {
...
app.get('/npc_codes', async (req, res) => {
    try {
...
app.post('/generate-caricom', async (req, res) => {
    const data = req.body;
